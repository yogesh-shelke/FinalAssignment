package Application_POMClasses;

import org.openqa.selenium.By;
import org.openqa.selenium.WebDriver;

import ReusableComponents.Applicationl_ReusableMethods;
...
public class OrangeHRM_Login {
    ...
    public WebDriver loginToOrangeHRM(WebDriver driver, String strUserName,String strPasword)
    {
       ...
       // Applicationl_ReusableMethods.isElementPresnt(driver, "xpath", "name", "txtUsername", 20).sendKeys("Admin");
       // Applicationl_ReusableMethods.isElementPresnt(driver, "cssSelector", "name", "txtPassword", 20).sendKeys("admin123");
